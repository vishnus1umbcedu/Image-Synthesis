...
if __name__ == "__main__":
    ...
    adj_mtx = g_am.AddToGraph(1,2,math.inf)
    rsd_mtx = g_rm.AddToGraph(1,2,math.inf)
    ng = 1
    ngbr_mtrx = g_ngbr.AddToGraph(1,ng,2)
    ng += 1

    adj_mtx = g_am.AddToGraph(1,3,math.inf)
    rsd_mtx = g_rm.AddToGraph(1,3,math.inf)
    ...
    ng += 1
    adj_mtx = g_am.AddToGraph(4,6,math.inf)
    rsd_mtx = g_rm.AddToGraph(4,6,math.inf)
    ...
    adj_mtx = g_am.AddToGraph(5,6,math.inf)
    rsd_mtx = g_rm.AddToGraph(5,6,math.inf)
    ng = 1
