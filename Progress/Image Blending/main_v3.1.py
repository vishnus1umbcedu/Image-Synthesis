...
#print(adj_mtx)
#print(adj_mtx[0][272])
#ngbr_mtx = n.AddToGraph(5442,0,0)
#ngbr_mtx = n.AddToGraph(5442,1,0)
...
for i in range(0,273):
    l.append(ngbr_mtx[0][i])
adj_dict[1] = l
#print(adj_dict)
print(adj_dict,file=open("log.txt","a"))

k = 2
while k < 5442:
    l.clear()
    for j in range(0,5):
        l.append(ngbr_mtx[k-1][j])
    adj_dict.clear()
    adj_dict[k] = l
    #print(adj_dict)
    print(adj_dict,file=open("log.txt","a"))
