...
import copy
import numpy as np
imghut = "C:/Users/parin/OneDrive/Desktop/Python/hut.jpg"
imgmount = "C:/Users/parin/OneDrive/Desktop/Python/mountain.jpg"
...
cv2.imwrite("C:/Users/parin/OneDrive/Desktop/result/test/result.jpg", croppedimg1)
color = (img1[200, 200])
#print (color[0]-color[1])
croppedimg2 = img2[0:236,0:272]
croppedresult = cv2.vconcat([croppedimg2,croppedimg1])
cv2.imwrite("C:/Users/parin/OneDrive/Desktop/result/test/result2.jpg", croppedimg2)
cv2.imwrite("C:/Users/parin/OneDrive/Desktop/result/test/resultf.jpg", croppedresult)

overlap1 = img1[90:110,0:272]
overlap2 = img2[230:250,0:272]
cv2.imwrite("C:/Users/parin/OneDrive/Desktop/result/overlap1.jpg", overlap1)
cv2.imwrite("C:/Users/parin/OneDrive/Desktop/result/overlap2.jpg", overlap2)
